...
INSERT INTO config(name, value, description) values("email_from","","Email address to send emails from");
...
INSERT INTO config(name, value, description) values("server_name","nerf-assassin", "Server name used in the URL");
INSERT INTO config(name, value, description) values("server_port", "8080", "Server port to use");
INSERT INTO config(name, value, description) values("server_ip", "0.0.0.0", "IP for server to bind to");
INSERT INTO config(name, value, description) values("server_ssl", "0", "Use SSL for server");
INSERT INTO config(name, value, description) values("server_certificate", "", "Path to SSL Certificate");
INSERT INTO config(name, value, description) values("server_private", "", "Path to SSL Private Key");
COMMIT;
